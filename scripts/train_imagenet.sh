...
#SBATCH --output=/n/fs/xl-diffbia/projects/stylegan2-ada/logs/slurm/2023-04-26/imagenet_cond_gan.txt            # where stdout and stderr will write to
...
--cond=1 --aug=noaug --batch=128 --workers=4 \
